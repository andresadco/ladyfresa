    ...
    <div style={S.root}>
      ...
      {todayG.length>0&&(
        <div style={{padding:"0 16px"}}>
          <ST>Hoy</ST>
          {todayG.slice(0,4).map(g=><GastoRow key={g.id} g={g} onDelete={deleteGasto} onEdit={startEdit} inusual={esInusual(g.cat,g.monto)} canEdit={usuarioActual==="Andres"||g.quien===usuarioActual}/>)}
        </div>
      )}
...
function GastoRow({g,onDelete,onEdit,inusual,canEdit}){
